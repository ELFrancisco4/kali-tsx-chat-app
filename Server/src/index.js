...
const { addUser, removeUser, getUser, getUsersInRoom, } = require("./helper-functions");
const app = express();
...
io.on("connection", (socket) => {
    ...
    socket.on("join", ({ name, room }, callback) => {
        ...
        if (error) {
            ...
            socket.join(user.room); // Add new socket to room
        socket.emit("message", {
            user: "admin",
    ...
    socket.emit("onlineStatus", (users, callback) => {
